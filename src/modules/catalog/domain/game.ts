...
export const demoGames: readonly Game[] = [
  ...
  { id: "ultimate-chicken-horse", name: "Ultimate Chicken Horse", shortName: "UCH", source: "steam", externalId: "386940", accent: "#f1bf43", broVBroSuitability: "featured" },
  { id: "nidhogg", name: "Nidhogg", shortName: "NID", source: "steam", externalId: "94400", accent: "#ef5ea8", broVBroSuitability: "featured" },
  ...
  { id: "brawlhalla", name: "Brawlhalla", shortName: "BH", source: "steam", externalId: "291550", accent: "#816bff", broVBroSuitability: "recommended" },
